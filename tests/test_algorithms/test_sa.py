...
class TestSimulatedAnnealing:
    ...
    def test_simulated_annealing_with_callback(self):
        ...
        simulated_annealing(problem, random_state=SEED, state_fitness_callback=callback_function, callback_user_info=user_data)

        # Assert that the callback was called
        assert len(user_data["iterations"]) > 0
    ...
    def test_simulated_annealing_callback_stop(self):
        ...
        simulated_annealing(problem, random_state=SEED, state_fitness_callback=callback_function, callback_user_info=None)
    ...
    def test_simulated_annealing_max_attempts_reached(self):
        ...
        assert max(user_data) == max_attempts
